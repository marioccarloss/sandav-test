...
import { BattleSelectorWrapper, TeamColumn, TeamList } from './battle-selector-page.styled';
    ...
    return (
        <BattleSelectorWrapper>
            ...
            <div style={{ textAlign: 'center', marginTop: '24px' }}>
                ...
                {team1Id && team1Id === team2Id && <p style={{ color: 'red', marginTop: '10px' }}>No puedes seleccionar el mismo equipo.</p>}
            </div>
        </BattleSelectorWrapper>
    );
};
